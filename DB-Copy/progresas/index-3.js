...
do {
  ...
  switch (meniu = parseInt(await inputText("Ivesk komanda: "))) {
    ...
    case 1:
      ...
      break;
    case 2:
      var vardas = await inputText("Vardas: ");
      var pavarde = await inputText("Pavarde: ");
      var alga = parseFloat(await inputText("Kokia bus alga?: "));
      var gim_data = await inputText("Gimimo data?: ");
      var id = parseInt(await inputText("Koks yra id: "));
      await dbQuery(
